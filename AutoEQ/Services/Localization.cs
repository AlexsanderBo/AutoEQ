...
public sealed class Localization : INotifyPropertyChanged
{
    ...
    private static readonly Dictionary<string, string> Vi = new()
    {
        ...
        ["analysis.source"] = "Kết quả phân tích",
        ...
        ["board.signal.tag"] = "LIVE · DSP",
        ["turntable.title"] = "Mâm đĩa tín hiệu",
        ["turntable.desc"] = "Hiển thị trực quan tín hiệu âm thanh đang xử lý theo thời gian thực",
        ["nowplaying.label"] = "Đang phát",
        ["nowplaying.from"] = "Đang thu từ:",
        ["media.prev"] = "Bài trước",
        ["media.playpause"] = "Phát / Tạm dừng",
        ["media.next"] = "Bài kế",

        // Flow card 1 - waveform
        ["flow.wave.title"] = "Dạng sóng đầu vào",
        ...
        ["flow.spec.title"] = "Phổ tần số đầu ra",
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["analysis.source"] = "Analysis result",
        ...
        ["turntable.desc"] = "Real-time visual of the audio signal being processed",
        ["nowplaying.label"] = "Now playing",
        ["nowplaying.from"] = "Capturing from:",
        ...
        // Flow card 3 - spectrum
        ["flow.spec.title"] = "Output spectrum",
