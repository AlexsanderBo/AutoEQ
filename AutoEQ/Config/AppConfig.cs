...
{
    public const string AppName = "AutoEQ";
    ...
    public const string AutoEQEqFile = @"C:\Program Files\EqualizerAPO\config\AutoEQ_autoeq.txt";
    ...
    public const int NativeFreshnessSeconds = 10;
}